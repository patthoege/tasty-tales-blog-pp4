from . import views
from .views import AddPost, SearchResults, Tagged, draft_list, EditDraft
from .views import DeleteDraft, about_me, CategoryView, CategoryPosts
...
urlpatterns = [
    ...
    path(
        'publish_draft/<slug:slug>/',
        EditDraft.as_view(), name='publish_draft'
        ),
    path(
        'drafts/delete/<slug:slug>/',
        DeleteDraft.as_view(), name='delete_draft'
        ),
